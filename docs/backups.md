...
3. Upgrade every machine that reads or writes this backup to v0.4.0 or newer before publishing its first new snapshot. This includes machines using Homebrew; v0.3.13 and earlier are insufficient.
